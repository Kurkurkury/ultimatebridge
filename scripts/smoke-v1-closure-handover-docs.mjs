...
const checks = {
  ...
  builderHasSafetyFlags: text.builder.includes('docsOnly: true') && text.builder.includes('noReleasePublish: true') && text.builder.includes('noGitTag: true') && text.builder.includes('noUpload: true'),
  builderDoesNotStartExternalTools: !/spawnSync|execSync|fetch\(|Start-Process/i.test(text.builder),
